...
def explain_prediction(probability, input_dict, surname):
  ...
  churned_stats = df[df['Exited'] == 1].describe().to_string()  # Convert DataFrame to string
...
def generate_email(probability, input_dict, explanation, surname):
    ...
    You Have noticed a customer named {surname} has a {round(probability * 100, 1)}% probability of churning.
